...
- [BBR_dataset_generation.ipynb](https://github.com/VanessaYan/STAT-453-Malaria-Bounding-Boxes-Detection/blob/master/code/RCNN/BBR_dataset_generation.ipynb): Generate data for Bounding box regression use.
